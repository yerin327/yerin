...
public class ScheduleEntity {
	...
	private int evt_reg;
	@XmlElement(name = "evt_category")
	private int evt_category;
	...
	public int getEvt_category() {
		return evt_category;
	}
	public void setEvt_category(int evt_category) {
		this.evt_category = evt_category;
	}
