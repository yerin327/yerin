...
--
-- Table structure for table `ds_board_tx`
--
...
CREATE TABLE `ds_board_tx` (
  ...
  `BOARD_TYPE` tinyint(4) DEFAULT NULL,
...
--
-- Dumping data for table `ds_board_tx`
--

LOCK TABLES `ds_board_tx` WRITE;
/*!40000 ALTER TABLE `ds_board_tx` DISABLE KEYS */;
/*!40000 ALTER TABLE `ds_board_tx` ENABLE KEYS */;
UNLOCK TABLES;
