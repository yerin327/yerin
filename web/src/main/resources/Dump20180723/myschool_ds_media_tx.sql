...
--
-- Table structure for table `ds_media_tx`
--
...
--
-- Dumping data for table `ds_media_tx`
--

LOCK TABLES `ds_media_tx` WRITE;
/*!40000 ALTER TABLE `ds_media_tx` DISABLE KEYS */;
/*!40000 ALTER TABLE `ds_media_tx` ENABLE KEYS */;
UNLOCK TABLES;
