...
--
-- Table structure for table `ds_user_spec_mst`
--
...
--
-- Dumping data for table `ds_user_spec_mst`
--

LOCK TABLES `ds_user_spec_mst` WRITE;
/*!40000 ALTER TABLE `ds_user_spec_mst` DISABLE KEYS */;
/*!40000 ALTER TABLE `ds_user_spec_mst` ENABLE KEYS */;
UNLOCK TABLES;
