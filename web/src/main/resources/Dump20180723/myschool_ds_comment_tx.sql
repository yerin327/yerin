...
--
-- Table structure for table `ds_comment_tx`
--
...
--
-- Dumping data for table `ds_comment_tx`
--

LOCK TABLES `ds_comment_tx` WRITE;
/*!40000 ALTER TABLE `ds_comment_tx` DISABLE KEYS */;
/*!40000 ALTER TABLE `ds_comment_tx` ENABLE KEYS */;
UNLOCK TABLES;
