(function(){
      ...
      resize:function(){
        ...
        $(canvas).click(function(e){
        	var pos = $(this).offset();
      		...
      		if (selected.node.data.link != null) {
  ...
  var Maps = function(elt){
    ...
    var _maps = {
      ...
      */
      mypath:{title:"", p:{stiffness:500}, source:_sources.nations} /*,
    ...
    var that = {
      ...
      selectMap:function(map_id){
       /* $.getJSON("/Deviewstory/atlas/maps/"+map_id+".json",
          function(data){
    	  ...
    	  $.ajax({
	        	url: '/user/myprofile/myPathJson.do',
	            dataType: "jsonp",
		        jsonp: "callback",
