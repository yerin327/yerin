	...
	<div class="contents_inner">
		<div class="contents_left">
			<div class="guardian_area">
				...
				<p class="guardian_name">◯○ ◯○◯<span>(학생:중학교3학년 여자)</span></p>
			</div>
			<p class="profile_edit"><a href="#">프로필 편집</a></p>
			<p class="blog_list"><a href="#">마이 블로그 목록</a></p>
			<p class="blog_list"><a href="#">전체 블로그 목록</a></p>
		</div>
		<div class="contents_right blog_enter">
			<div class="attention"><span>제목를 입력해 주세요.<br>문자를 입력해 주세요.</span></div>
				...
				<div class="myblog_wrap">
					<div class="BlogEnterBlock">
						<dl class="BlogEnterTitle">
							<dt>제목<span class="notes">*</span><span>(00문자이내) 0/00</span></dt>
							<dd><input type="text"></dd>
						</dl>
						<dl class="BlogEnterDesc">
							<dt>본문<span class="notes">*</span><span>(00문자이내) 0/00</span></dt>
							<dd><textarea cols="30"></textarea></dd>
						</dl>
					</div>
					<p class="notice"><a href="/rules.jsp" target="_blank">이용규칙</a> 또는 <a href="/privacy_policy.jsp" target="_blank">개인정보취급에 대하여</a>을 확인, 동의한 뒤에 작성해 주십시오.</p>
					<div class="formButtons">
						<ul>
							<li><input type="submit" class="formBt01" value="입력내용 확인"></li>
						</ul>
					</div>
				</div>
			</form>
