	...
	$( "#dialog-confirm" ).dialog({
	    ...
	    buttons: {
	      "Yes": function() {
	    	  $( this ).dialog( "close" );
	    	  var frm = document.f1;
	    	  frm.action = "<%=request.getContextPath()%>/common/blog/myblog_proc.do";
	    	  frm.submit();
	      },
	      "No": function() {
	          $( this ).dialog( "close" );
...
function doSubmit() {
	...
	$( "#dialog-confirm" ).html("<span class='ui-icon ui-icon-check' style='float:left; margin:0 7px 20px 0;'></span>이 내용으로" + msg + " 등록할까요?");
	$( "#dialog-confirm" ).dialog( "open" );
}

function doBack() {
	var frm = document.f1;
	frm.action = "<%=request.getContextPath()%>/common/blog/myblog_enter.do";
	frm.submit();
}
</script>
</head>
...
<input type="hidden" name="contents" value=<c:out value='${contents }'/>> 
</form>
...
<div class="contents centerfix">
	...
	<div class="contents_inner">
		<div class="contents_left">
			...
			<p class="blog_list"><a href="<%=request.getContextPath()%>/common/blog.do">전체 블로그 목록</a></p>
		</div>
		<div class="contents_right blog_confirm">
			...
			<div class="myblog_wrap">
				<div class="listBlogBlock">
					...
					<div class="article_conf"><c:out value='${contents }'/></div>
				</div>
				<div class="formButtons">
					<ul>
						<li><input type="button" class="formBt01" value="작성하기" onclick="doSubmit()"></li>
						<li><input type="button" class="formBt02" value="돌아가기" onclick="doBack()"></li>
					</ul>
				</div>
			</div>
		</div>
