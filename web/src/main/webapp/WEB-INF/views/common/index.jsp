...
(function(d, s, id) {
  ...
  function checkLoginState() {
	...
	FB.getLoginStatus(function(response) {
      isCLickedLogin = true;
      console.log("test2=" + isCLickedLogin);
      //statusChangeCallback(response);
      if (response.status === 'connected') {
	      connected();
	    } else if (response.status === 'not_authorized') {
...
<div class="headerwrap01">
    ...
    <div class="sp_app_link">
    	<h3>MY SCHOOL APP</h3>
    	<p>스마트 폰으로 스케줄이나<br> 블로그를 관리할 수 있습니다.</p>
    	<ul>
    		<li><img src="<%=request.getContextPath() %>/images/locale/ja/user/pages/top/img_iphoneapp.png" alt=""></li>
    		<li><img src="<%=request.getContextPath() %>/images/locale/ja/user/pages/top/img_androidapp.png" alt=""></li>
    	</ul>
    </div>
	<a href="javascript:openLogin();">
    ...
    <div class="searchForm">
    	<form action="<%=request.getContextPath() %>/common/search.do" id="frm" method="post" name="frm">
			...
			<div class="checkWrap">
				...
				<label><input type="checkbox" name="keywords" value="CK0000021">매점, 카페</label>
...
<div class="pr_pickup">
	<div class="pr_inner">
		...
		<div class="pickup_wrap">
			<%-- <a href="<%=request.getContextPath() %>/pickupschool.jsp"> --%>
			<div class="pickup clearfix">
				<div class="pickup_img"><img src="${pickup_img }" width="391" height="350" alt=""></div>
	...
	<div class="pr_inner">
		...
		<div class="guardian_wrap">
			<c:forEach items="${blog_list }" var="blog" varStatus="status">
				<div class="guardian <c:out value='${blog.gender_str }'/>" onclick="doBlogMove(<c:out value='${blog.idx}'/>)">
