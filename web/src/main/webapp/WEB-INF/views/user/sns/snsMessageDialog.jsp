...
<div id="sns_messageOut" style="width: 880px; height: 410px; overflow-y: hidden; background-color: #ecf4e9;" >
            ...
            <div class="panel-body">
                <ul class="timeline">
                	...
                	<c:forEach var="con" items="${constList }" varStatus="status">
	                    ...
	                    <c:set var="preStatus" value="${con.const_status}" />
                	</c:forEach>
                </ul>
            </div>
            <!-- /.panel-body -->
