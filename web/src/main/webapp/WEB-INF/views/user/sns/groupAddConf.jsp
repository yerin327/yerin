...
<table  style="width:600px; border: 0px;">
	...
	<tr>
		...
		<td class="input_td" style="width:70px;">&nbsp;</td>
		<td class="input_td" style="width:510px; height: 50px; text-align: left;">
			<c:out value='${group_entity.user_id }'/>
		</td>
	</tr>
</table>
<form name="f1" id="f1" method="post">
	<input type="hidden" name="group_name" value="<c:out value='${group_entity.group_name}'/>" />
	<input type="hidden" name="user_id" value="<c:out value='${group_entity.user_id}'/>" />
</form>	
</div>
