...
<section class="form_area">
	...
	<div class="tab_area">
    	 <ul>
        	<li><img src="<%=request.getContextPath() %>/images/locale/ja/user/pages/news/news_on.png" alt="news" width="186" height="50" border="0"></li>
            <li><a href="<%=request.getContextPath() %>/user/news/eventList.do"><img src="<%=request.getContextPath() %>/images/locale/ja/user/pages/news/event_off.png" alt="event" width="186" height="50" border="0"></a></li>
        </ul>
    </div>
	<div class="form_box">
...
<div id="dialog-view" title="뉴스상세표시">
