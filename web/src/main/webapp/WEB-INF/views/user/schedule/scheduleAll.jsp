...
$(document).ready(function() {
	...
	$('#calendar').fullCalendar({
		...
		events: function(start, end, timezone, callback) {
	        $.ajax({
	        	url: '<%=request.getContextPath() %>/user/schedule/scheduleJson.do?student_id=${userEntity.user_id }&isAll=yes',
	            dataType: "jsonp",
		        jsonp: "callback",
	            data: {
...
<section class="form_area">
	<div class="tab_area">
    	 <ul>
            ...
            <li><img src="<%=request.getContextPath() %>/images/locale/ja/user/pages/schedule/consult_on.png" alt="consult" width="186" height="50" border="0"></li>
        </ul>
    </div>
...
<div id="dialog-view-reg" title="스케줄상세표시（신청가능）">
  <form id="evtView" method="post">
  <fieldset>
  	<label for="title">제목</label>
