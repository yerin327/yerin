...
<section class="form_area">
	<div class="tab_area">
    	 <ul>
            ...
            <li><img src="<%=request.getContextPath() %>/images/locale/ja/customer/pages/school/recomend_std_on.png" alt="추천 학생" width="186" height="50" border="0"></li>
		                            ...
		                            <tbody>
		                            	<c:forEach var="student" items="${student_list }" varStatus="status">
			                                ...
			                                <tr class="<c:out value='${rowClass}'/>">
			                                    ...
			                                    <td style="width: 200px;"><c:out value='${student.cur_school}'/></td>
			                                    <td class="center" style="width: 100px;"><c:out value='${student.location}'/></td>
			                                    <td class="center" style="width: 100px;"><c:out value='${student.ins_date}'/></td>
			                                </tr>
		                                </c:forEach>
		                            </tbody>
		                        </table>
