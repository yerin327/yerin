...
<section class="form_area">
	...
	<div class="tab_area">
    	 <ul>
        	<li><a href=""><img src="<%=request.getContextPath() %>/images/locale/ja/customer/pages/statistics/customer_on.png" alt="custome" width="186" height="50" border="0"></a></li>
            <li><a href=""><img src="<%=request.getContextPath() %>/images/locale/ja/customer/pages/statistics/user_off.png" alt="user" width="186" height="50" border="0"></a></li>
            <li><a href=""><img src="<%=request.getContextPath() %>/images/locale/ja/customer/pages/statistics/consultant_off.png" alt="consultant" width="186" height="50" border="0"></a></li>
        </ul>
