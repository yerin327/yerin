...
$(function() {
	...
	$('#container').highcharts({
        chart: { type: 'line' },
        title: { text: '기타 - 즐겨찾기 건수, 추천건수, 조회수' },
...
<section class="form_area">
	...
	<div class="tab_area">
    	 <ul>
            ...
            <li><a href="<%=request.getContextPath() %>/customer/statistics/statUser.do"><img src="<%=request.getContextPath() %>/images/locale/ja/customer/pages/statistics/member2_off.png" alt="회언등록수" width="186" height="50" border="0"></a></li>
            <li><a href="<%=request.getContextPath() %>/customer/statistics/statConsult.do"><img src="<%=request.getContextPath() %>/images/locale/ja/customer/pages/statistics/question2_off.png" alt="추천상담수" width="186" height="50" border="0"></a></li>
            <li><img src="<%=request.getContextPath() %>/images/locale/ja/customer/pages/statistics/other_on.png" alt="기타" width="186" height="50" border="0"></li>
        </ul>
